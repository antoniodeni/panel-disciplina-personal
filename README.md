...
En Ajustes puedes activar tres recordatorios locales: inicio, pausa y cierre.
La aplicacion muestra tambien una sugerencia inteligente basada en el estado
personal, la carga de tareas y la prioridad del dia. Los habitos se repiten
segun los dias que configures en cada pilar y no se convierten automaticamente
en tareas duplicadas. Los avisos del sistema funcionan mientras la aplicacion
esta abierta; los avisos con la aplicacion cerrada quedan para una fase
posterior con servicio de notificaciones.

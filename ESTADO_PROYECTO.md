...
36. Mejora del domingo 2 de agosto: recordatorios configurables de inicio,
    pausa y cierre, permiso explicito para avisos del sistema, sugerencia
    inteligente segun estado personal, carga y prioridad, y lectura de cuantos
    habitos recurrentes corresponden al dia. La recurrencia usa la configuracion
    de dias existente y no crea tareas duplicadas. La app queda preparada para
    avisos mientras esta abierta; las notificaciones con la app cerrada quedan
    como fase posterior. Esquema de datos actualizado a v6 y cache a v33.
    No tocar Engranaje Sur.
37. Correccion del acceso el 2 de agosto: el formulario ahora informa cuando
    falta el correo o la contrasena y muestra mensajes claros si falla la
    conexion o el servicio de autenticacion. Cache actualizada a v34 para
    renovar tambien la version instalada en movil. No tocar Engranaje Sur.
